...
from publication.tunning.tun_single_tunning_test import run_single_tunning_test


def single_combination_tunning(algorithm,
    ...
    hvs = []
    for seed in seeds:
        _, hv, _, _ = run_single_tunning_test(algorithm,
    ...
    for i in range(10):
        ...
        # Check for unallowed population size
        if n_pop < 20:
            modif = modif * (-1)
            n_pop = n_pop + (pop_step * modif)
            pop_step = pop_step // 2
