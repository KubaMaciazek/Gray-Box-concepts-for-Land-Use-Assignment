...
# tunned_source = 'tunning/tunned_parameters_dictionary_nsgaii.txt'
tunned_source = 'tunning/tunned_parameters_dictionary_nsgaii_0505.txt'


def run_tests_for_tunned_best():
    """
    ...
    test_stamp = "1728300766_nsgaii_tuned_0505"
