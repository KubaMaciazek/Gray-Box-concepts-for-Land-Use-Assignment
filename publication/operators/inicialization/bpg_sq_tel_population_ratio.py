...
def sq_bpg_50x50_tel_bgp_strict_pr(pcls, ind_init, areal_file, sq_file, urbanization_quantity, n_pop):
    """
    ...
    for k in range(n_pop):
        ...
        if k < half_1st:
            ...
            # 6) Select new agri cells, biased by the number of their urban neighbours
            while i < urbanization_quantity:
                selected_position = random.randint(0, len(available_xs) - 1)
...
def test_sq_bpg_50x50_tel_bgp_strict_pr():
    sq_file = ("C:/Users/kubam/OneDrive/DYSK_S_Studia/PRACA_MAGISTERSKA/"
               + "ZSTI_Magisterka_Kod_Conda/schwaab/data_gemeinden_zuerich/Uster/sq.tif")
    areal_file = ("C:/Users/kubam/OneDrive/DYSK_S_Studia/PRACA_MAGISTERSKA/"
                  + "ZSTI_Magisterka_Kod_Conda/schwaab/data_gemeinden_zuerich/Uster/areal_4_09.tif")
    ...
    population = sq_bpg_50x50_tel_bgp_strict_pr(list, creator.Individual, areal_file, sq_file, urbanization_quantity, n_pop)
    # print(population)
    plot_lulc_map(population[0], 'individual')  # log


# Test
# test_sq_bpg_50x50_tel_bgp_strict_pr()
