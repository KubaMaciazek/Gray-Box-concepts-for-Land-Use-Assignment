...
from publication.general_test.tests_configs import get_nsgaii_tunning_config
from publication.tunning.single_combination_tunning import single_combination_tunning


def run_tunning():
    (algorithm, n_pop, NFFE, cxpb, mutpb, w1, w2, seeds, sample_municipalities, list_initializations, list_mutations,
     list_crossovers, list_repairs, nr_of_tests, test_nr, starting_time, test_stamp) = get_nsgaii_tunning_config()

    test_stamp = '1731746812_nt_0505'
    ...
    for sample in sample_municipalities:
        ...
        with concurrent.futures.ProcessPoolExecutor() as executor:
            futures = [executor.submit(single_combination_tunning, *arg) for arg in args_filtered]
